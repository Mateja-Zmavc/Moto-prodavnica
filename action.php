                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>$700.00</del></h4>
		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>Proizvod je vec dodat u korpu</b>
				</div>
			";//not in video
		} else {
			...
			if (mysqli_query($con,$sql)) {
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Vas proizvod je uspesno dodat!</b>
					</div>
				";
				exit();
			}
		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
							...
							<td data-th="Proizvod" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>Kupite kod NAS i uverite se u kvalitet!</p>
										</div>
									</div>
				...
				<tfoot>
					...
					<tr>
						<td><a href="store.php" class="btn btn-warning"><i class="fa fa-angle-left"></i> Nastavite sa kupovinom</a></td>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-success">Kupi</a></td>
								</tr>
							</tfoot>
