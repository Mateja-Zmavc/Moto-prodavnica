...
<link rel="stylesheet" type="text/css" href="assets/css/stil.css">
	...
	<a class=" btn btn-primary" href="addproduct.php" style="background: linear-gradient(to right ,#000, #54034c,#000);">Dodaj novi</a></th></tr></thead>
                    <tbody>
                      <?php 
                        ...
                        <a class=' btn btn-success' id='btn_obr' href='clothes_list.php?product_id=$product_id&action=delete' >Obrisi</a>
                        </td></tr>";
                        }
